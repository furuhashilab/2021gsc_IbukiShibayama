...
### モデリング
Blenderでのモデリングにおいても特に致命的な問題は無かったが、ループカットや押し出しを積み重ねるうちに構造が複雑化して引き起こされる問題があった。細かい調整や修正を行おうとすると頂点や辺が二重に出来てしまったり、面の裏表が逆向きになってしまうことがある。こういった問題がないかこまめにチェックし、重複があればマージし、面が逆向きであれば正しい向きへ反転させる必要がある。
